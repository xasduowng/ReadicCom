...
function handleDisplayElement() {
    ...
    size < 479 ? handleNavWeb() : console.log("Tablet or Laptop");
...
//     const inputSearch = z('.search-input');
//     inputSearch.oninput = () => {
//         searchGenre(xoa_dau(inputSearch.value.toLowerCase()));
//     }
